import { buildEmojiDictUsingClient, editMessageUsingClient, publishMessageUsingClient, sendMessageUsingClient, uploadEmojisUsingClient, } from "./_utils/raw-utils.js";
 ...
 * returns the emoji dict
 */
export async function uploadEmojiList(apiToken, guild, emojis) {
    return doSomethingUsingTempClient(apiToken, (client) => {
