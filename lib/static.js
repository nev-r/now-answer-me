import { buildEmojiDictUsingClient, editMessageUsingClient, publishMessageUsingClient, sendMessageUsingClient, uploadEmojiListUsingClient, } from "./raw-utils.js";
 ...
 * returns the emoji dict
 */
export async function uploadEmoteList(apiToken, guild, emoteList) {
    return doSomethingUsingTempClient(apiToken, (client) => {
