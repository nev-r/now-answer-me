 ...
 */
export async function sendPaginatedSelector({ user, channel, contentList, optionRenderer = (l, i) => ({ name: i, value: `${l}`, inline: true }), resultRenderer = (l) => new MessageEmbed({ description: `${l}` }), itemsPerPage = 25, }) {
    var _a;
    ...
    try {
        while (true) {
            ...
            if (finalSelection !== undefined && done) {
                ...
                embed = new MessageEmbed().addFields(...contentList
        ...
        paginatedMessage === null || paginatedMessage === void 0 ? void 0 : paginatedMessage.delete();
    }
}
/**
