import { Embed, InteractionReplyOptions, InteractionUpdateOptions, Message, MessageOptions, MessagePayload } from "discord.js";
...
export declare function sendableToInteractionReplyOptions(sendable: MessageOptions | InteractionReplyOptions | Embed | string): InteractionReplyOptions | MessageOptions;
export declare function sendableToInteractionUpdateOptions(sendable: MessageOptions | InteractionReplyOptions | Embed | string): InteractionUpdateOptions;
export declare function sendableToPayload(sendable: MessagePayload | Embed | string | Sendable): MessagePayload | (MessageOptions & {
