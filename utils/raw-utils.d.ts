...
export declare function replyOrEdit(interaction: CommandInteraction | MessageComponentInteraction, content: Parameters<CommandInteraction["reply"]>[0] | Parameters<CommandInteraction["editReply"]>[0]): Promise<void> | Promise<import("discord-api-types").APIMessage | import("discord.js").Message<true> | import("discord.js").Message<boolean>> | ((r: Parameters<CommandInteraction["reply"]>[0] | Parameters<CommandInteraction["editReply"]>[0]) => void);
export declare function updateComponent(interaction: MessageComponentInteraction, content: Parameters<MessageComponentInteraction["editReply"]>[0]): Promise<void> | Promise<import("discord-api-types").APIMessage | import("discord.js").Message<true> | import("discord.js").Message<boolean>>;
/**
 ...
 */
export declare function forceFeedback(interaction: CommandInteraction | MessageComponentInteraction, content: Parameters<CommandInteraction["followUp"]>[0] | Parameters<CommandInteraction["reply"]>[0] | Parameters<CommandInteraction["editReply"]>[0]): Promise<void> | Promise<import("discord-api-types").APIMessage | import("discord.js").Message<true> | import("discord.js").Message<boolean>>;
export {};
